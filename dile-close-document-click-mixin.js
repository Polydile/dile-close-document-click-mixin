 ...
 * 
 */
export const DileCloseDocumentClickMixin = (SuperClass) => class extends SuperClass {
  ...
  disconnectedCallback() {
    ...
    DileCloseDocumentClickMixin.elements = DileCloseDocumentClickMixin.elements.filter(item => item != this); 
   ...
   */
  close() {
    console.log('DileCloseDocumentClickMixin needs a close() method in the component');
  }
}